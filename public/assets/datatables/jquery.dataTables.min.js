...
!function (n) {
    ...
    function Lt(n) {
        ...
        var t = n.oClasses, a = n.sTableId, r = n.oLanguage, o = n.oPreviousSearch, i = n.aanFeatures, l = '<input type="search" class="form-control form-control-sm bordered me-1 mt-1' + t.sFilterInput + '"/>', s = (s = r.sSearch).match(/_INPUT_/) ? s.replace("_INPUT_", l) : s + l,
    ...
    function Qt(n) {
        ...
        var e, a, r, o, i, l = n.oScroll, s = l.sX, u = l.sXInner, c = l.sY, l = l.iBarWidth, f = P(n.nScrollHead), d = f[0].style, h = f.children("div"), p = h[0].style, h = h.children("table"), g = n.nScrollBody, b = P(g), m = g.style, S = P(n.nScrollFoot).children("div"), v = S.children("table"),
            y = P(n.nTHead), D = P(n.nTable), _ = D[0], w = _.style, C = n.nTFoot ? P(n.nTFoot) : null, T = n.oBrowser, x = T.bScrollOversize, A = (N(n.aoColumns, "nTh"), []), I = [], F = [], L = [], R = g.scrollHeight > g.clientHeight;
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
    ...
    }), w.version = "1.13.5", w.settings = [], w.models = {}, w.models.oSearch = {bCaseInsensitive: !0, sSearch: "", bRegex: !1, bSmart: !0, return: !1}, w.models.oRow = {
        nTr: null,
        anCells: null,
        _aData: [],
        _aSortData: null,
        ...
        sTable: "dataTable",
        sNoFooter: "no-footer",
        sPageButton: "paginate_button btn btn-sm btn-outline-primary me-1",
        sPageButtonActive: "current btn btn-sm btn-primary text-white me-1",
        sPageButtonDisabled: "disabled btn btn-sm btn-outline-secondary me-1",
        sStripeOdd: "odd",
        sStripeEven: "even",
        ...
        sFilterInput: "",
        sLengthSelect: "form-select form-select-sm bordered mt-1",
